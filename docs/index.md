...
[Review the dataset and load it into OpenRefine](#A)  
[Perform some basic data cleanup to get familiar with the OpenRefine interface](#B)  
[Use OpenRefine to sort, filter and facet data](#C)  
[Transpose the data from wide format to long format](#D)  
[Explore more advanced uses of facets](#E)  
[General Refine Expression Language (GREL)](#F)  
[Export data from OpenRefine](#G)
...
![Numeric facet window with handles highlighted]({{ '/assets/images/openrefineworkshop13a.png' | relative_url }})  
![Numeric facet with handles brought tight around the blue column]({{ '/assets/images/openrefineworkshop13b.png' | relative_url }})
...
Technique: [Cleaning data](/technique/cleaning-data) \| Tools: [OpenRefine](/tools/openrefine)**Date Created:** 2019\-03\-25**Updated:** 2023\-10\-23
